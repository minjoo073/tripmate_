...
export function FinalCTA() {
  return (
    <section id="reviews" data-reveal className="bg-card pt-[88px]">
      <div className="mx-auto w-full max-w-[1200px] px-6 sm:px-10">
        <div className="flex flex-col items-stretch gap-10 md:flex-row md:gap-16 md:min-h-[420px]">
          ...
          <div className="flex flex-1 flex-col justify-center gap-7">
            <h2 className="m-0 text-[40px] font-black leading-[1.1] tracking-[-0.04em] text-text-primary sm:text-[54px] sm:leading-[1.02]">
              나만의
              <br />
              여행 메이트와
              <br />
            ...
            <p className="m-0 max-w-[340px] text-[16px] leading-[1.75] text-text-secondary">
              여행지·날짜·스타일만 입력하면
              <br />
      ...
      <div id="download" className="mt-[52px] bg-primary-light py-[26px]">
        <div className="mx-auto flex w-full max-w-[1200px] flex-col items-center justify-between gap-4 px-6 sm:px-10 md:flex-row">
          <div className="flex items-baseline gap-4">
            <span className="text-[22px] font-black tracking-[-0.02em] text-accent">
              무료 가입
            </span>
